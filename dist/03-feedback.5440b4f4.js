...
refs.formEl.addEventListener("input", (0, _lodash.throttle)(onFormInput, 500));
...
const getStoredObject = (storageKey)=>{
    try {
        return localStorage.getItem(storageKey) === null ? undefined : JSON.parse(localStorage.getItem(storageKey));
    } catch (error) {
